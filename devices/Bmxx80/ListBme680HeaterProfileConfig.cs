...
namespace System.Collections.Generic
{
    ...
    public class ListBme680HeaterProfileConfig : IEnumerable
    {
        ...
        public bool Contains(Bme680HeaterProfileConfig item)
        {
            ...
            {
                if (((Bme680HeaterProfileConfig)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public ListBme680HeaterProfileConfig GetRange(int index, int count)
        {
            ...
            for (int i = index; i < count; i++)
            {
                list.Add((Bme680HeaterProfileConfig)_list[i]);
            }
        ...
        public int IndexOf(Bme680HeaterProfileConfig item) => IndexOf(item, 0, _list.Count);
        ...
        public int LastIndexOf(Bme680HeaterProfileConfig item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        public int LastIndexOf(Bme680HeaterProfileConfig item, int index, int count)
        {
            ...
            {
                if (((Bme680HeaterProfileConfig)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        {
            Bme680HeaterProfileConfig[] array = new Bme680HeaterProfileConfig[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (Bme680HeaterProfileConfig)_list[i];
            }
