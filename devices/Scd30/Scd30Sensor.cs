...
namespace Iot.Device.Scd30
{
    ...
    /// </summary>
    /// <remarks>
    /// Most of the SCD30 documentation below is derived or copied from the original documentation, which can be found at:
    ...
    public class Scd30Sensor
    {
        ...
        /// <summary>
        /// Create an instance to control the SCD30 via <see cref="SerialPort"/>. The BaudRate, DataBits, Parity, StopBits and timeouts will be configured automatically to interact with the SCD30.
        /// </summary>
