...
namespace BlueNrg2
{
	...
	public class Events
	{
		...
		private readonly EventTableType[] _leMetaEventsTable;
		private readonly EventTableType[] _vendorSpecificEventsTable;
		private EventTableType[] _eventsTable;
		...
		public Events()
		{
			...
			_vendorSpecificEventsTable = new[]
			{
