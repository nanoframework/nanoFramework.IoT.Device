...
namespace System.Buffers.Helpers.BitConverter
{
    ...
    public interface IBitConverter
    {
        ...
        char ToChar(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        short ToInt16(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        int ToInt32(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        long ToInt64(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        ushort ToUInt16(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        uint ToUInt32(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        ulong ToUInt64(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        float ToSingle(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        double ToDouble(ReadOnlySpan<byte> value, int index = 0);
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        bool ToBoolean(ReadOnlySpan<byte> value, int index = 0);
    }
}
