...
namespace System.Buffers.Helpers.BitConverter
{
    ...
    public class LittleEndianBitConverter : EndianBitConverter
    {
        ...
        public override char ToChar(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override short ToInt16(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override int ToInt32(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override long ToInt64(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override ushort ToUInt16(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override uint ToUInt32(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override ulong ToUInt64(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override float ToSingle(Span<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override double ToDouble(Span<byte> value, int index = 0)
        {
