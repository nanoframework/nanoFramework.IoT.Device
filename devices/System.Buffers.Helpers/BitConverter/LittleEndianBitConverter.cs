...
namespace System.Buffers.Helpers.BitConverter
{
    ...
    public class LittleEndianBitConverter : EndianBitConverter
    {
        ...
        public override char ToChar(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override short ToInt16(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override int ToInt32(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override long ToInt64(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override ushort ToUInt16(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override uint ToUInt32(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override ulong ToUInt64(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override float ToSingle(ReadOnlySpan<byte> value, int index = 0)
        {
        ...
        /// <param name="index">The index where the data can be found.</param>
        /// <returns>The converted data.</returns>
        public override double ToDouble(ReadOnlySpan<byte> value, int index = 0)
        {
