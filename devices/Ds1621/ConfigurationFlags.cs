...
{
    /// <summary>
    /// Ds1621 configuration register flags.
    /// </summary>
    [Flags]
    internal enum ConfigurationFlags : byte
    {
        /// <summary>
        ...
        /// </remarks>
        OneShotConversionMode = 0b0000_0001,
        ...
        NonvolatileMemoryBusy = 0b0001_0000,
        ...
        LowTemperatureAlarm = 0b0010_0000,
        ...
        HighTemperatureAlarm = 0b0100_0000,
        ...
        /// </remarks>
        TemperatureConversionDone = 0b1000_0000
    }
}
