...
namespace Pcd8544.samples
{
    public class Program
    {
        public static void Main()
        {
            ...
            var lcd = new Iot.Device.Display.Pcd8544(dataCommandPin, spiDevice, resetPin, pwmChannel, gpioController, false);
            lcd.Enabled = true;
            lcd.Bias = 6;
            lcd.Contrast = 40;
        ...
        static void BrightnessContrastTemperatureBias(Iot.Device.Display.Pcd8544 lcd)
        {
            lcd.Clear();
        ...
        static void DisplayTextChangePositionBlink(Iot.Device.Display.Pcd8544 lcd)
        {
            lcd.Clear();
        ...
        static void DisplayBitmap(Iot.Device.Display.Pcd8544 lcd)
        {
            lcd.Clear();
        ...
        static void DisplayLinesPointsRectabngles(Iot.Device.Display.Pcd8544 lcd)
        {
            lcd.Clear();
            ...
            lcd.DrawPoint(Iot.Device.Display.Pcd8544.PixelScreenSize.Width - 1, 0, true);
            lcd.DrawPoint(Iot.Device.Display.Pcd8544.PixelScreenSize.Width - 1, Iot.Device.Display.Pcd8544.PixelScreenSize.Height - 1, true);
            lcd.DrawPoint(0, Iot.Device.Display.Pcd8544.PixelScreenSize.Height - 1, true);
            lcd.Draw();
            Thread.Sleep(2000);
            Console.WriteLine("Drawing a rectangle at 2 pixels from the edge");
            lcd.DrawRectangle(2, 2, Iot.Device.Display.Pcd8544.PixelScreenSize.Width - 4, Iot.Device.Display.Pcd8544.PixelScreenSize.Height - 4, true, false);
            lcd.Draw();
            Thread.Sleep(2000);
            lcd.Clear();
            Console.WriteLine("Drawing 2 diagonal lines");
            lcd.DrawLine(0, 0, Iot.Device.Display.Pcd8544.PixelScreenSize.Width - 1, Iot.Device.Display.Pcd8544.PixelScreenSize.Height - 1, true);
            lcd.DrawLine(0, Iot.Device.Display.Pcd8544.PixelScreenSize.Height - 1, Iot.Device.Display.Pcd8544.PixelScreenSize.Width - 1, 0, true);
            lcd.Draw();
            Thread.Sleep(2000);
        }

        static void LcdConsole(Iot.Device.Display.Pcd8544 lcd)
        {
            lcd.Clear();
