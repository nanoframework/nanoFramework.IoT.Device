...
namespace Iot.Device.Button
{
    ...
    public class GpioButton : ButtonBase
    {
        ...
        public GpioButton(int buttonPin, GpioController gpio = null, PinMode pinMode = PinMode.InputPullUp, bool shouldDispose = true) : this(buttonPin, TimeSpan.FromTicks(DefaultDoublePressTicks), TimeSpan.FromMilliseconds(DefaultHoldingMilliseconds), gpio, pinMode, shouldDispose)
        {
        }
        ...
        /// <param name="gpio">Gpio Controller.</param>
        /// <param name="shouldDispose">True to dispose the GpioController.</param>
        public GpioButton(int buttonPin, TimeSpan doublePress, TimeSpan holding, GpioController gpio = null, PinMode pinMode = PinMode.InputPullUp, bool shouldDispose = true)
