...
namespace Iot.Device.CharacterLcd
{
    ...
    public class LcdValueUnitDisplay
    {
        ...
        private readonly Hashtable _font;
        ...
        public void InitForRom(string romName, LcdCharacterEncodingFactory? factory = null)
        {
            ...
            lock (_lock)
            {
                ...
                Hashtable specialGraphicsRequired = new Hashtable();
        ...
        public void DisplayBigTextAsync(string text, TimeSpan scrollSpeed, CancellationToken cancellationToken)
        {
            ...
            while (startPosition < totalColumnsUsed)
            {
                ...
                if (WaitHandle.WaitAny(new[] { cancellationToken.WaitHandle }, (int)scrollSpeed.TotalMilliseconds, true) != WaitHandle.WaitTimeout)
                {
                    break;
                }
        ...
        private void CreateSpecialChars(Hashtable graphicChars)
        {
