...
namespace Iot.Device.BuildHat.Sensors
{
    ...
    public class ActiveSensor : Sensor
    {
        ...
        internal ListModeDetail ModeDetailsInternal;
        internal ListCombiModes CombiModesInternal;
        ...
        /// </summary>
        public CombiModes[] CombiModes { get => CombiModesInternal.ToArray(); }

        /// <summary>
        /// Gets the mode details of the sensor.
        /// </summary>
        public ModeDetail[] ModeDetails { get => ModeDetailsInternal.ToArray(); }
        ...
        {
            ModeDetailsInternal = new ListModeDetail();
            CombiModesInternal = new ListCombiModes();
        }
        ...
        {
            trigger = false;
            DateTime dt = DateTime.UtcNow.AddSeconds(TimeoutMeasuresSeconds);
            Brick.SelectModeAndRead(Port, mode, once);

            while (!trigger && (dt > DateTime.UtcNow))
            {
                Thread.Sleep(10);
            }
