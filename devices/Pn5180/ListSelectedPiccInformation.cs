...
{
    /// <summary>
    /// List class for type SelectedPiccInformation that has been automatically generated
    /// </summary>
    internal class ListSelectedPiccInformation : IEnumerable
    {
        ...
        /// </summary>
        public ListSelectedPiccInformation()
        {
            _list = new ArrayList();
        }
        ...
        public ListSelectedPiccInformation(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListSelectedPiccInformation(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public SelectedPiccInformation this[int index]
        {
            get
            {
                ...
                return (SelectedPiccInformation)_list[index];
            }
        ...
        public void Add(SelectedPiccInformation item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type SelectedPiccInformation is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListSelectedPiccInformation _collection;
            ...
            /// </summary>
            public SelectedPiccInformation Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(SelectedPiccInformation item)
        {
            foreach (var elem in _list)
            {
                if (((SelectedPiccInformation)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(SelectedPiccInformation[] array, int arrayIndex)
        {
        ...
        public void CopyTo(SelectedPiccInformation[] array)
        {
        ...
        public void CopyTo(int index, SelectedPiccInformation[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (SelectedPiccInformation)_list[i];
            }
        }
        ...
        public ListSelectedPiccInformation GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListSelectedPiccInformation();
            for (int i = index; i < count; i++)
            {
                list.Add((SelectedPiccInformation)_list[i]);
            }
        ...
        public int IndexOf(SelectedPiccInformation item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(SelectedPiccInformation item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(SelectedPiccInformation item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, SelectedPiccInformation item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type SelectedPiccInformation is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(SelectedPiccInformation item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(SelectedPiccInformation item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(SelectedPiccInformation item, int index, int count)
        {
            ...
            {
                if (((SelectedPiccInformation)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(SelectedPiccInformation item)
        {
        ...
        public SelectedPiccInformation[] ToArray()
        {
            SelectedPiccInformation[] array = new SelectedPiccInformation[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (SelectedPiccInformation)_list[i];
            }
