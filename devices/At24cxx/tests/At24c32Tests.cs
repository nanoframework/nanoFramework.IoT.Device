...
{
    [TestClass]
    public class At24c32Tests
    {
        static I2cDevice _i2cDevice;
        static At24c32 _eeprom;
        static Random _random;

        // Expected device metrics for At24c32 from datasheet (page 1 section 1. Description).
        // https://ww1.microchip.com/downloads/en/DeviceDoc/doc5298.pdf
        const int _expectedSize = 4096;
        const int _expectedPageSize = 32;
        const int _expectedPageCount = 128;
        ...
        public void SetupTests()
        {
            try
            {
                ...
                // Setup device. 
                I2cConnectionSettings i2cSettings = new I2cConnectionSettings(1, At24c32.DefaultI2cAddress);
                _i2cDevice = new I2cDevice(i2cSettings);
                _eeprom = new At24c32(_i2cDevice);
        ...
        {
            Assert.ThrowsException(typeof(ArgumentNullException), () => new At24c32(null));
        }
