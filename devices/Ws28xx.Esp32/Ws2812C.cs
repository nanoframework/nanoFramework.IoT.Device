...
namespace Iot.Device.Ws28xx.Esp32
{
    ...
    public class Ws2812c : Ws28xx
    {
        ...
        /// <param name="rmtChannel">The RMT channel number to use. Valid values are 0 to 7 (inclusive), or -1 to auto-select an available channel.</param>
        public Ws2812c(int gpioPin, int width, int height = 1, int rmtChannel = -1)
