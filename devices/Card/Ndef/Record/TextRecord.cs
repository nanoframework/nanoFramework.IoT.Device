    ...
    public class TextRecord : NdefRecord
    {
        ...
        public Encoding Encoding
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException($"Encoding can only be {Encoding.UTF8}");
                }
        ...
        public TextRecord(Span<byte> record)
            : base(record)
        {
            ExtractAll();
        }
        ...
        private void ExtractAll()
        {
            ...
            // nano only supports UTF8, so let's try with UTF8
            _encoding = Encoding.UTF8;

            var langSize = Payload[0] & 0b0011_1111;

            _languageCode = Encoding.GetString(Payload, 1, langSize);
        ...
        private void SetPayload()
        {
            ...
            {
                Encoding.GetBytes(_languageCode).CopyTo(Payload, 1);
        ...
        public static bool IsTextRecord(NdefRecord ndefRecord)
        {
            ...
            if ((ndefRecord.Header.PayloadType != null) && (ndefRecord.Header.PayloadType[0] != 0x54))
            {
                return false;
            }
