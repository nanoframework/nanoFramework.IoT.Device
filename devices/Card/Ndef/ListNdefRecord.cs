...
namespace System.Collections.Generic
{
    ...
    public class ListNdefRecord : IEnumerable
    {
        ...
        public NdefRecord this[int index]
        {
            get
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type NdefRecord is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListNdefRecord _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListNdefRecord collection)
            {
                _index = -1;
            ...
            /// </summary>
            public NdefRecord Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(NdefRecord item)
        {
            ...
            {
                if (((NdefRecord)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(int index, NdefRecord[] array, int arrayIndex, int count)
        {
            ...
            {
                array[arrayIndex + i] = (NdefRecord)_list[i];
            }
        }
        ...
        public ListNdefRecord GetRange(int index, int count)
        {
            ...
            var list = new ListNdefRecord();
            for (int i = index; i < count; i++)
            {
                list.Add((NdefRecord)_list[i]);
            }
        ...
        public int IndexOf(NdefRecord item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(NdefRecord item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(NdefRecord item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, NdefRecord item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type NdefRecord is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(NdefRecord item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(NdefRecord item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(NdefRecord item, int index, int count)
        {
            ...
            {
                if (((NdefRecord)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        {
            NdefRecord[] array = new NdefRecord[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (NdefRecord)_list[i];
            }
