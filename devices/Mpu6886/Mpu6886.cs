...
namespace Iot.Device.Mpu6886
{
    ...
    public class Mpu6886AccelerometerGyroscope : IDisposable
    {
            ...
            I2cDevice i2cDevice)
        {
            ...
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.PowerManagement1, 0b0000_0000 });
            Thread.Sleep(10);

            _i2c.Write(new byte[] { (byte)Mpu6886.Register.PowerManagement1, 0b0100_0000 });
            Thread.Sleep(10);

            _i2c.Write(new byte[] { (byte)Mpu6886.Register.PowerManagement1, 0b0000_0001 });
            Thread.Sleep(10);
            ...
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.Configuration, 0b0000_0001 });
            Thread.Sleep(1);
            ...
            // ACCEL_CONFIG 2(0x1d)
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.AccelerometerConfiguration2, 0b0000_0000 });
            Thread.Sleep(1);

            // USER_CTRL(0x6a)
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.UserControl, 0b0000_0000 });
            Thread.Sleep(1);

            // FIFO_EN(0x23)
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.FifoEnable, 0b0000_0000 });
            Thread.Sleep(1);

            // INT_PIN_CFG(0x37)
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.IntPinBypassEnabled, 0b0010_0010 });
            Thread.Sleep(1);

            // INT_ENABLE(0x38), "Data ready interrupt enable" bit
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.InteruptEnable, 0b0000_0001 });
            Thread.Sleep(100);
            ...
            //Datasheet page 46
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.AccelerometerIntelligenceControl, 0b0000_0010 });
            Thread.Sleep(10);
        }
        ...
        public void Reset()
        {
            _i2c.Write(new byte[] { (byte)Mpu6886.Register.PowerManagement1, 0b1000_0000 });
            Thread.Sleep(10);
        }
        ...
        public AccelerometerScale AccelerometerScale
        {
            ...
            set
            {
                ...
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.AccelerometerConfiguration1, newvalue });
        ...
        public GyroscopeScale GyroscopeScale
        {
            ...
            set
            {
                ...
                // write the new register value
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.GyroscopeConfiguration, newvalue });
        ...
        public EnabledAxis EnabledAxes
        {
            ...
            set
            {
                ...
                // write the new register value
                // bit 1 in the register means disabled, so using bitwise not to flip bits.
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.PowerManagement2, (byte)~newvalue });
        ...
        public AccelerometerLowPowerMode AccelerometerLowPowerMode
        {
            ...
            set
            {
                ...
                // write the new register value
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.AccelerometerConfiguration2, newvalue });
                Thread.Sleep(2);
            }
        }
        ...
        public byte SampleRateDivider
        {
            ...
            set
            {
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.SampleRateDevider, value });
                Thread.Sleep(1);
            }
        }
        ...
        public InterruptEnable AccelerometerInterruptEnabled
        {
            ...
            set
            {
                ...
                // write the new register value
                _i2c.Write(new byte[] { (byte)Mpu6886.Register.InteruptEnable, newvalue });
                Thread.Sleep(2);
