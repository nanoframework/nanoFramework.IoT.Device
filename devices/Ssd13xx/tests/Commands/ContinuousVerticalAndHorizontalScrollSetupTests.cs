...
namespace Iot.Device.Ssd13xx.Tests
{
    ...
    {
        [TestMethod]
        public void Get_BytesContinuousVerticalAndHorizontalScrollSetupTests()
        {
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Left, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00 });
            // StartPageAddress
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page1, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x01, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page2, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x02, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page3, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x03, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page4, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x04, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page5, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x05, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page6, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x06, 0x00, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page7, FrameFrequencyType.Frames5, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x07, 0x00, 0x00, 0x00 });
            // FrameFrequencyType
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames64, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x01, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames128, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x02, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames256, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x03, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames3, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x04, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames4, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x05, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames25, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x06, 0x00, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames2, PageAddress.Page0, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x07, 0x00, 0x00 });
            // EndPageAddress
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page1, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x01, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page2, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x02, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page3, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x03, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page4, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x04, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page5, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x05, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page6, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x06, 0x00 });
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page7, 0x00, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x07, 0x00 });
            // VerticalScrollingOffset
            Get_Bytes(VerticalHorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page0, 0x3F, new byte[] { 0x29, 0x00, 0x00, 0x00, 0x00, 0x3F });
        }
