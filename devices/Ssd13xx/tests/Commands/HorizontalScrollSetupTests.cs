...
namespace Iot.Device.Ssd13xx.Tests
{
    ...
    {
        [TestMethod]
        public void Get_BytesHorizontalScrollSetupTests()
        {
            // HorizontalScrollType
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Left, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF });
            // StartPageAddress
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page1, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page2, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x02, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page3, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x03, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page4, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page5, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x05, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page6, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x06, 0x00, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page7, FrameFrequencyType.Frames5, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x07, 0x00, 0x00, 0x00, 0xFF });
            // FrameFrequencyType
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames64, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x01, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames128, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x02, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames256, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x03, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames3, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x04, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames4, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x05, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames25, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x06, 0x00, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames2, PageAddress.Page0, new byte[] { 0x26, 0x00, 0x00, 0x07, 0x00, 0x00, 0xFF });
            // EndPageAddress
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page1, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x01, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page2, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x02, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page3, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x03, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page4, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x04, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page5, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x05, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page6, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x06, 0x00, 0xFF });
            Get_Bytes(HorizontalScrollType.Right, PageAddress.Page0, FrameFrequencyType.Frames5, PageAddress.Page7, new byte[] { 0x26, 0x00, 0x00, 0x00, 0x07, 0x00, 0xFF });
        }
