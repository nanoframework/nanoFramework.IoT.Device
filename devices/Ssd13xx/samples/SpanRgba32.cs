...
namespace Iot.Device.Ssd13xx
{
    ...
    /// </summary>
    public readonly ref struct SpanRgba32
    {
        private readonly Rgba32[] _array;  // internal array
        ...
        public SpanRgba32(Rgba32[] array)
        {
            _array = array;
        ...
        /// </exception>
        public SpanRgba32(Rgba32[] array, int start, int length)
        {
            if (array != null)
            {
                if (start < 0 ||
        ...
        // public ref Rgba32 this[int index] => ref _array[_start + index]; // <= this is not working and raises exception after few access
        ...
        /// </summary>
        public static SpanRgba32 Empty => new SpanRgba32();
        ...
        /// </exception>
        public void CopyTo(SpanRgba32 destination)
        {
        ...
        public SpanRgba32 Slice(int start)
        {
        ...
        public SpanRgba32 Slice(int start, int length)
        {
            ...
            return new SpanRgba32(_array, _start + start, length);
        }
        ...
        public static implicit operator SpanRgba32(Rgba32[] array)
        {
            return new(array);
        }
    }
