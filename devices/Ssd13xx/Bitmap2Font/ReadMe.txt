...
It is using typical 'Bitmap Fonts' as font definition, see examples here: http://www.orangetide.com/fonts/DOS/ and in many different places.
These bitmap files should contain black lettering on white background. Other bitmaps need to be first processed with graphical programs.
