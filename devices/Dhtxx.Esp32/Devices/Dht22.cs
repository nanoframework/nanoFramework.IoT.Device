...
namespace Iot.Device.DHTxx.Esp32
{
    ...
    public class Dht22 : DhtBase
    {
        ...
        /// <param name="rmtChannel">The RMT channel number to use. Valid values are 0 to 7 (inclusive), or -1 to auto-select a free channel.</param>
        public Dht22(int pinEcho, int pinTrigger, PinNumberingScheme pinNumberingScheme = PinNumberingScheme.Logical, GpioController? gpioController = null, bool shouldDispose = true, int rmtChannel = -1)
