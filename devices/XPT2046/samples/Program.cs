...
// Flag to record if the sensor has been touched in interupt call back routine.
...
try
{
    ...
    Xpt2046 sensor = new Xpt2046(spiDevice);
...
void TouchInteruptCallback(object sender, PinValueChangedEventArgs pinValueChangedEventArgs)
{
    touchDetected = true;
}
