...
{
    /// <summary>
    /// List class for type ManagementObjectSearcher that has been automatically generated
    /// </summary>
    public class ListManagementObjectSearcher : IEnumerable
    {
        ...
        /// </summary>
        public ListManagementObjectSearcher()
        {
            _list = new ArrayList();
        }
        ...
        public ListManagementObjectSearcher(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListManagementObjectSearcher(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ManagementObjectSearcher this[int index]
        {
            get
            {
                ...
                return (ManagementObjectSearcher)_list[index];
            }
        ...
        public void Add(ManagementObjectSearcher item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ManagementObjectSearcher is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListManagementObjectSearcher _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListManagementObjectSearcher collection)
            {
                _index = 0;
            ...
            /// </summary>
            public ManagementObjectSearcher Current => _collection[_index];
        ...
        public bool Contains(ManagementObjectSearcher item)
        {
            foreach (var elem in _list)
            {
                if (((ManagementObjectSearcher)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ManagementObjectSearcher[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ManagementObjectSearcher[] array)
        {
        ...
        public void CopyTo(int index, ManagementObjectSearcher[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ManagementObjectSearcher)_list[i];
            }
        }
        ...
        public ListManagementObjectSearcher GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListManagementObjectSearcher();
            for (int i = index; i < count; i++)
            {
                list.Add((ManagementObjectSearcher)_list[i]);
            }
        ...
        public int IndexOf(ManagementObjectSearcher item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ManagementObjectSearcher item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ManagementObjectSearcher item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ManagementObjectSearcher item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ManagementObjectSearcher is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ManagementObjectSearcher item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ManagementObjectSearcher item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ManagementObjectSearcher item, int index, int count)
        {
            ...
            {
                if (((ManagementObjectSearcher)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ManagementObjectSearcher item)
        {
        ...
        public ManagementObjectSearcher[] ToArray()
        {
            ManagementObjectSearcher[] array = new ManagementObjectSearcher[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ManagementObjectSearcher)_list[i];
            }
