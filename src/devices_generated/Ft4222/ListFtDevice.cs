...
{
    /// <summary>
    /// List class for type FtDevice that has been automatically generated
    /// </summary>
    public class ListFtDevice : IEnumerable
    {
        ...
        public ListFtDevice(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListFtDevice(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public FtDevice this[int index]
        {
            get
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type FtDevice is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListFtDevice _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListFtDevice collection)
            {
                _index = 0;
            ...
            /// </summary>
            public FtDevice Current => _collection[_index];
        ...
        public bool Contains(FtDevice item)
        {
            foreach (var elem in _list)
            {
                if (((FtDevice)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(FtDevice[] array, int arrayIndex)
        {
        ...
        public void CopyTo(FtDevice[] array)
        {
        ...
        public void CopyTo(int index, FtDevice[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (FtDevice)_list[i];
            }
        }
        ...
        public ListFtDevice GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListFtDevice();
            for (int i = index; i < count; i++)
            {
                list.Add((FtDevice)_list[i]);
            }
        ...
        public int IndexOf(FtDevice item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(FtDevice item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(FtDevice item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, FtDevice item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type FtDevice is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(FtDevice item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(FtDevice item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(FtDevice item, int index, int count)
        {
            ...
            {
                if (((FtDevice)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(FtDevice item)
        {
        ...
        public FtDevice[] ToArray()
        {
            FtDevice[] array = new FtDevice[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (FtDevice)_list[i];
            }
