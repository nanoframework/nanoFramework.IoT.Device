namespace System
{
    ...
    public readonly ref struct SpanGpioTrigger
    {
        private readonly GpioTrigger[] _array;  // internal array
        ...
        public SpanGpioTrigger(GpioTrigger[] array)
        {
            _array = array;
        ...
        /// </exception>
        public SpanGpioTrigger(GpioTrigger[] array, int start, int length)
        {
            if (array != null)
            {
                if (start < 0 ||
        ...
        // public ref GpioTrigger this[int index] => ref _array[_start + index]; // <= this is not working and raises exception after few access
        public GpioTrigger this[int index]
        {
            get
            {
                if (index >= _length)
        ...
        /// </summary>
        public static SpanGpioTrigger Empty => new SpanGpioTrigger();
        ...
        /// </exception>
        public void CopyTo(SpanGpioTrigger destination)
        {
        ...
        public SpanGpioTrigger Slice(int start)
        {
        ...
        public SpanGpioTrigger Slice(int start, int length)
        {
            ...
            return new SpanGpioTrigger(_array, _start + start, length);
        }
        ...
        public GpioTrigger[] ToArray()
        {
            var array = new GpioTrigger[_length];
            for (int i = 0; i < _length; i++)
            {
        ...
        public static implicit operator SpanGpioTrigger(GpioTrigger[] array)
        {
            return new(array);
        }
    }
