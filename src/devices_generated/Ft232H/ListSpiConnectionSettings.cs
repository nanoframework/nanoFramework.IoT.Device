...
{
    /// <summary>
    /// List class for type SpiConnectionSettings that has been automatically generated
    /// </summary>
    public class ListSpiConnectionSettings : IEnumerable
    {
        ...
        /// </summary>
        public ListSpiConnectionSettings()
        {
            _list = new ArrayList();
        }
        ...
        public ListSpiConnectionSettings(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListSpiConnectionSettings(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public SpiConnectionSettings this[int index]
        {
            get
            {
                ...
                return (SpiConnectionSettings)_list[index];
            }
        ...
        public void Add(SpiConnectionSettings item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type SpiConnectionSettings is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListSpiConnectionSettings _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListSpiConnectionSettings collection)
            {
                _index = -1;
            ...
            /// </summary>
            public SpiConnectionSettings Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(SpiConnectionSettings item)
        {
            foreach (var elem in _list)
            {
                if (((SpiConnectionSettings)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(SpiConnectionSettings[] array, int arrayIndex)
        {
        ...
        public void CopyTo(SpiConnectionSettings[] array)
        {
        ...
        public void CopyTo(int index, SpiConnectionSettings[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (SpiConnectionSettings)_list[i];
            }
        }
        ...
        public ListSpiConnectionSettings GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListSpiConnectionSettings();
            for (int i = index; i < count; i++)
            {
                list.Add((SpiConnectionSettings)_list[i]);
            }
        ...
        public int IndexOf(SpiConnectionSettings item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(SpiConnectionSettings item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(SpiConnectionSettings item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, SpiConnectionSettings item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type SpiConnectionSettings is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(SpiConnectionSettings item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(SpiConnectionSettings item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(SpiConnectionSettings item, int index, int count)
        {
            ...
            {
                if (((SpiConnectionSettings)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(SpiConnectionSettings item)
        {
        ...
        public SpiConnectionSettings[] ToArray()
        {
            SpiConnectionSettings[] array = new SpiConnectionSettings[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (SpiConnectionSettings)_list[i];
            }
