...
namespace Iot.Device.Ft232H
{
    ...
    public class Ft232HDevice : FtDevice, IDisposable
    {
        ...
        internal ListSpiConnectionSettings ConnectionSettings = new ListSpiConnectionSettings();
        ...
        public static ListFt232HDevice GetFt232H()
        {
            ListFt232HDevice ft232s = new ListFt232HDevice();
