...
{
    /// <summary>
    /// List class for type Ft232HDevice that has been automatically generated
    /// </summary>
    public class ListFt232HDevice : IEnumerable
    {
        ...
        public ListFt232HDevice(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListFt232HDevice(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public Ft232HDevice this[int index]
        {
            get
            {
                ...
                return (Ft232HDevice)_list[index];
            }
        ...
        public void Add(Ft232HDevice item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Ft232HDevice is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListFt232HDevice _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListFt232HDevice collection)
            {
                _index = -1;
            ...
            /// </summary>
            public Ft232HDevice Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(Ft232HDevice item)
        {
            foreach (var elem in _list)
            {
                if (((Ft232HDevice)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(Ft232HDevice[] array, int arrayIndex)
        {
        ...
        public void CopyTo(Ft232HDevice[] array)
        {
        ...
        public void CopyTo(int index, Ft232HDevice[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Ft232HDevice)_list[i];
            }
        }
        ...
        public ListFt232HDevice GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListFt232HDevice();
            for (int i = index; i < count; i++)
            {
                list.Add((Ft232HDevice)_list[i]);
            }
        ...
        public int IndexOf(Ft232HDevice item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Ft232HDevice item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Ft232HDevice item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Ft232HDevice item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Ft232HDevice is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Ft232HDevice item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Ft232HDevice item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Ft232HDevice item, int index, int count)
        {
            ...
            {
                if (((Ft232HDevice)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(Ft232HDevice item)
        {
        ...
        public Ft232HDevice[] ToArray()
        {
            Ft232HDevice[] array = new Ft232HDevice[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (Ft232HDevice)_list[i];
            }
