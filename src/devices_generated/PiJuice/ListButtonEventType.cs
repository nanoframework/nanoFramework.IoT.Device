...
{
    /// <summary>
    /// List class for type ButtonEventType that has been automatically generated
    /// </summary>
    public class ListButtonEventType : IEnumerable
    {
        ...
        public ListButtonEventType(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListButtonEventType(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ButtonEventType this[int index]
        {
            get
            {
                ...
                return (ButtonEventType)_list[index];
            }
        ...
        public void Add(ButtonEventType item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ButtonEventType is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListButtonEventType _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListButtonEventType collection)
            {
                _index = -1;
            ...
            /// </summary>
            public ButtonEventType Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(ButtonEventType item)
        {
            foreach (var elem in _list)
            {
                if (((ButtonEventType)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ButtonEventType[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ButtonEventType[] array)
        {
        ...
        public void CopyTo(int index, ButtonEventType[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ButtonEventType)_list[i];
            }
        }
        ...
        public ListButtonEventType GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListButtonEventType();
            for (int i = index; i < count; i++)
            {
                list.Add((ButtonEventType)_list[i]);
            }
        ...
        public int IndexOf(ButtonEventType item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ButtonEventType item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ButtonEventType item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ButtonEventType item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ButtonEventType is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ButtonEventType item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ButtonEventType item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ButtonEventType item, int index, int count)
        {
            ...
            {
                if (((ButtonEventType)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ButtonEventType item)
        {
        ...
        public ButtonEventType[] ToArray()
        {
            ButtonEventType[] array = new ButtonEventType[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ButtonEventType)_list[i];
            }
