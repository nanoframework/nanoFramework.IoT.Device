...
{
    /// <summary>
    /// List class for type String that has been automatically generated
    /// </summary>
    public class ListString : IEnumerable
    {
        ...
        public ListString(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type string is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListString _collection;
            ...
            /// </summary>
            public string Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(string item)
        {
            ...
            {
                if (((string)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(int index, string[] array, int arrayIndex, int count)
        {
            ...
            {
                array[arrayIndex + i] = (string)_list[i];
            }
        }
        ...
        public int IndexOf(string item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(string item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(string item) => IndexOf(item, 0, _list.Count);
        ...
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type string is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(string item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(string item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(string item, int index, int count)
        {
            ...
            {
                if (((string)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
