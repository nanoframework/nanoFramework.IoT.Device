...
{
    /// <summary>
    /// List class for type ElectricCurrent that has been automatically generated
    /// </summary>
    public class ListElectricCurrent : IEnumerable
    {
        ...
        public ListElectricCurrent(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListElectricCurrent(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ElectricCurrent this[int index]
        {
            get
            {
                ...
                return (ElectricCurrent)_list[index];
            }
        ...
        public void Add(ElectricCurrent item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ElectricCurrent is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListElectricCurrent _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListElectricCurrent collection)
            {
                _index = -1;
            ...
            /// </summary>
            public ElectricCurrent Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(ElectricCurrent item)
        {
            foreach (var elem in _list)
            {
                if (((ElectricCurrent)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ElectricCurrent[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ElectricCurrent[] array)
        {
        ...
        public void CopyTo(int index, ElectricCurrent[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ElectricCurrent)_list[i];
            }
        }
        ...
        public ListElectricCurrent GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListElectricCurrent();
            for (int i = index; i < count; i++)
            {
                list.Add((ElectricCurrent)_list[i]);
            }
        ...
        public int IndexOf(ElectricCurrent item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ElectricCurrent item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ElectricCurrent item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ElectricCurrent item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ElectricCurrent is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ElectricCurrent item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ElectricCurrent item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ElectricCurrent item, int index, int count)
        {
            ...
            {
                if (((ElectricCurrent)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ElectricCurrent item)
        {
        ...
        public ElectricCurrent[] ToArray()
        {
            ElectricCurrent[] array = new ElectricCurrent[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ElectricCurrent)_list[i];
            }
