...
{
    /// <summary>
    /// List class for type ElectricPotential that has been automatically generated
    /// </summary>
    public class ListElectricPotential : IEnumerable
    {
        ...
        public ListElectricPotential(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListElectricPotential(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ElectricPotential this[int index]
        {
            get
            {
                ...
                return (ElectricPotential)_list[index];
            }
        ...
        public void Add(ElectricPotential item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ElectricPotential is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListElectricPotential _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListElectricPotential collection)
            {
                _index = -1;
            ...
            /// </summary>
            public ElectricPotential Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(ElectricPotential item)
        {
            foreach (var elem in _list)
            {
                if (((ElectricPotential)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ElectricPotential[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ElectricPotential[] array)
        {
        ...
        public void CopyTo(int index, ElectricPotential[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ElectricPotential)_list[i];
            }
        }
        ...
        public ListElectricPotential GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListElectricPotential();
            for (int i = index; i < count; i++)
            {
                list.Add((ElectricPotential)_list[i]);
            }
        ...
        public int IndexOf(ElectricPotential item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ElectricPotential item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ElectricPotential item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ElectricPotential item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ElectricPotential is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ElectricPotential item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ElectricPotential item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ElectricPotential item, int index, int count)
        {
            ...
            {
                if (((ElectricPotential)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ElectricPotential item)
        {
        ...
        public ElectricPotential[] ToArray()
        {
            ElectricPotential[] array = new ElectricPotential[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ElectricPotential)_list[i];
            }
