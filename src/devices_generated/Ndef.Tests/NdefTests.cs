...
namespace Ndef.Tests
{
    ...
    public class NdefTests
    {
        ...
        public void NdefTextRecordUTF8()
        {
            ...
            SpanByte txtRaw = new byte[] { 0x91, 0x01, 0x14, 0x54, 0x02, 0x65, 0x6E, 0x53, 0x75, 0x70, 0x65, 0x72, 0x20, 0xC3, 0xA7, 0x61, 0x20, 0x6D, 0x61, 0x72, 0x63, 0x68, 0x65, 0x20 };
        ...
        public void NdefMultipleWithNoise()
        {
            ...
            SpanByte geoNewSerialized = new byte[geoNew.Length];
            SpanByte geoSerialized = new byte[geo.Length];
            ...
            SpanByte mediaNewSerialized = new byte[mediaNew.Length];
            SpanByte mediaSerialized = new byte[message.Records.Last().Length];
            ...
            SpanByte messageNewSerialiazed = new byte[messageNew.Length];
            // Act
            ...
            SpanByte serializedMessage = new byte[message.Length];
        ...
        private byte[]? ExtractAllMessage(SpanByte toExtract)
        {
            int idx = 0;
        ...
        private byte[] ExtractAllBlocksFromCardDump(SpanByte toExtract)
        {
            const int BlockSize = 16;
            // Remove the 3 blocks + Sector tailor to remove
            SpanByte toReturn = new byte[toExtract.Length * 3 / 4];
