...
{
    /// <summary>
    /// List class for type ModeDetail that has been automatically generated
    /// </summary>
    public class ListModeDetail : IEnumerable
    {
        ...
        public ListModeDetail(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListModeDetail(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ModeDetail this[int index]
        {
            get
            {
        ...
        public void Add(ModeDetail item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ModeDetail is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListModeDetail _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListModeDetail collection)
            {
                _index = -1;
            ...
            /// </summary>
            public ModeDetail Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(ModeDetail item)
        {
            foreach (var elem in _list)
            {
                if (((ModeDetail)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ModeDetail[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ModeDetail[] array)
        {
        ...
        public void CopyTo(int index, ModeDetail[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ModeDetail)_list[i];
            }
        }
        ...
        public ListModeDetail GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListModeDetail();
            for (int i = index; i < count; i++)
            {
                list.Add((ModeDetail)_list[i]);
            }
        ...
        public int IndexOf(ModeDetail item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ModeDetail item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ModeDetail item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ModeDetail item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ModeDetail is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ModeDetail item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ModeDetail item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ModeDetail item, int index, int count)
        {
            ...
            {
                if (((ModeDetail)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ModeDetail item)
        {
        ...
        public ModeDetail[] ToArray()
        {
            ModeDetail[] array = new ModeDetail[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ModeDetail)_list[i];
            }
