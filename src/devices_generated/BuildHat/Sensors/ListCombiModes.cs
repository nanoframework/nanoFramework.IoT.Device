...
{
    /// <summary>
    /// List class for type CombiModes that has been automatically generated
    /// </summary>
    public class ListCombiModes : IEnumerable
    {
        ...
        public ListCombiModes(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListCombiModes(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public CombiModes this[int index]
        {
            get
            {
        ...
        public void Add(CombiModes item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type CombiModes is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListCombiModes _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListCombiModes collection)
            {
                _index = -1;
            ...
            /// </summary>
            public CombiModes Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(CombiModes item)
        {
            foreach (var elem in _list)
            {
                if (((CombiModes)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(CombiModes[] array, int arrayIndex)
        {
        ...
        public void CopyTo(CombiModes[] array)
        {
        ...
        public void CopyTo(int index, CombiModes[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (CombiModes)_list[i];
            }
        }
        ...
        public ListCombiModes GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListCombiModes();
            for (int i = index; i < count; i++)
            {
                list.Add((CombiModes)_list[i]);
            }
        ...
        public int IndexOf(CombiModes item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(CombiModes item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(CombiModes item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, CombiModes item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type CombiModes is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(CombiModes item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(CombiModes item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(CombiModes item, int index, int count)
        {
            ...
            {
                if (((CombiModes)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(CombiModes item)
        {
        ...
        public CombiModes[] ToArray()
        {
            CombiModes[] array = new CombiModes[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (CombiModes)_list[i];
            }
