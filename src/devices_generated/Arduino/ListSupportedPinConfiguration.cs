...
{
    /// <summary>
    /// List class for type SupportedPinConfiguration that has been automatically generated
    /// </summary>
    public class ListSupportedPinConfiguration : IEnumerable
    {
        ...
        /// </summary>
        public ListSupportedPinConfiguration()
        {
            _list = new ArrayList();
        }
        ...
        public ListSupportedPinConfiguration(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListSupportedPinConfiguration(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public SupportedPinConfiguration this[int index]
        {
            get
            {
                ...
                return (SupportedPinConfiguration)_list[index];
            }
        ...
        public void Add(SupportedPinConfiguration item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type SupportedPinConfiguration is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListSupportedPinConfiguration _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListSupportedPinConfiguration collection)
            {
                _index = 0;
            ...
            /// </summary>
            public SupportedPinConfiguration Current => _collection[_index];
        ...
        public bool Contains(SupportedPinConfiguration item)
        {
            foreach (var elem in _list)
            {
                if (((SupportedPinConfiguration)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(SupportedPinConfiguration[] array, int arrayIndex)
        {
        ...
        public void CopyTo(SupportedPinConfiguration[] array)
        {
        ...
        public void CopyTo(int index, SupportedPinConfiguration[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (SupportedPinConfiguration)_list[i];
            }
        }
        ...
        public ListSupportedPinConfiguration GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListSupportedPinConfiguration();
            for (int i = index; i < count; i++)
            {
                list.Add((SupportedPinConfiguration)_list[i]);
            }
        ...
        public int IndexOf(SupportedPinConfiguration item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(SupportedPinConfiguration item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(SupportedPinConfiguration item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, SupportedPinConfiguration item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type SupportedPinConfiguration is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(SupportedPinConfiguration item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(SupportedPinConfiguration item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(SupportedPinConfiguration item, int index, int count)
        {
            ...
            {
                if (((SupportedPinConfiguration)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(SupportedPinConfiguration item)
        {
        ...
        public SupportedPinConfiguration[] ToArray()
        {
            SupportedPinConfiguration[] array = new SupportedPinConfiguration[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (SupportedPinConfiguration)_list[i];
            }
