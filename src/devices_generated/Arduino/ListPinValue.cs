...
{
    /// <summary>
    /// List class for type PinValue that has been automatically generated
    /// </summary>
    public class ListPinValue : IEnumerable
    {
        ...
        public ListPinValue(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListPinValue(int capacity)
        {
            if (capacity < 0)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type PinValue is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListPinValue _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListPinValue collection)
            {
                _index = 0;
            ...
            /// </summary>
            public PinValue Current => _collection[_index];
        ...
        public bool Contains(PinValue item)
        {
            foreach (var elem in _list)
            {
                if (((PinValue)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(PinValue[] array, int arrayIndex)
        {
        ...
        public void CopyTo(PinValue[] array)
        {
        ...
        public void CopyTo(int index, PinValue[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (PinValue)_list[i];
            }
        }
        ...
        public ListPinValue GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListPinValue();
            for (int i = index; i < count; i++)
            {
                list.Add((PinValue)_list[i]);
            }
        ...
        public int IndexOf(PinValue item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(PinValue item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(PinValue item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, PinValue item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type PinValue is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(PinValue item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(PinValue item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(PinValue item, int index, int count)
        {
            ...
            {
                if (((PinValue)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(PinValue item)
        {
        ...
        {
            PinValue[] array = new PinValue[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (PinValue)_list[i];
            }
