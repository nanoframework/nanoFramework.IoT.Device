...
{
    /// <summary>
    /// List class for type SupportedMode that has been automatically generated
    /// </summary>
    public class ListSupportedMode : IEnumerable
    {
        ...
        public ListSupportedMode(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListSupportedMode(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public SupportedMode this[int index]
        {
            get
            {
                ...
                return (SupportedMode)_list[index];
            }
        ...
        public void Add(SupportedMode item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type SupportedMode is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListSupportedMode _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListSupportedMode collection)
            {
                _index = 0;
            ...
            /// </summary>
            public SupportedMode Current => _collection[_index];
        ...
        public bool Contains(SupportedMode item)
        {
            foreach (var elem in _list)
            {
                if (((SupportedMode)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(SupportedMode[] array, int arrayIndex)
        {
        ...
        public void CopyTo(SupportedMode[] array)
        {
        ...
        public void CopyTo(int index, SupportedMode[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (SupportedMode)_list[i];
            }
        }
        ...
        public ListSupportedMode GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListSupportedMode();
            for (int i = index; i < count; i++)
            {
                list.Add((SupportedMode)_list[i]);
            }
        ...
        public int IndexOf(SupportedMode item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(SupportedMode item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(SupportedMode item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, SupportedMode item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type SupportedMode is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(SupportedMode item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(SupportedMode item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(SupportedMode item, int index, int count)
        {
            ...
            {
                if (((SupportedMode)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(SupportedMode item)
        {
        ...
        public SupportedMode[] ToArray()
        {
            SupportedMode[] array = new SupportedMode[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (SupportedMode)_list[i];
            }
