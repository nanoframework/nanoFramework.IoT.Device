...
{
    /// <summary>
    /// List class for type Int that has been automatically generated
    /// </summary>
    public class ListInt : IEnumerable
    {
        ...
        public ListInt(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type int is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListInt _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListInt collection)
            {
                _index = 0;
            ...
            /// </summary>
            public int Current => _collection[_index];
        ...
        public bool Contains(int item)
        {
            ...
            {
                if (((int)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(int index, int[] array, int arrayIndex, int count)
        {
            ...
            {
                array[arrayIndex + i] = (int)_list[i];
            }
        }
        ...
        public ListInt GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
        ...
        public int IndexOf(int item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(int item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(int item) => IndexOf(item, 0, _list.Count);
        ...
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type int is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(int item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(int item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(int item, int index, int count)
        {
            ...
            {
                if (((int)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
