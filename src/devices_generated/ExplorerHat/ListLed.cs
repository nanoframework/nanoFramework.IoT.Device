...
{
    /// <summary>
    /// List class for type Led that has been automatically generated
    /// </summary>
    public class ListLed : IEnumerable
    {
        ...
        public ListLed(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Led is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListLed _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListLed collection)
            {
                _index = -1;
            ...
            /// </summary>
            public Led Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(Led item)
        {
            foreach (var elem in _list)
            {
                if (((Led)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(Led[] array, int arrayIndex)
        {
        ...
        public void CopyTo(int index, Led[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Led)_list[i];
            }
        }
        ...
        public ListLed GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListLed();
            for (int i = index; i < count; i++)
            {
                list.Add((Led)_list[i]);
            }
        ...
        public int IndexOf(Led item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Led item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Led item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Led item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Led is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Led item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Led item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Led item, int index, int count)
        {
            ...
            {
                if (((Led)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
