...
namespace Iot.Device.GoPiGo3
{
    ...
    public class GoPiGo : IDisposable
    {
        ...
        public int SpiRead32(SpiMessageType MessageType)
        {
            ...
            {
                return BinaryPrimitives.ReadInt32BigEndian(new SpanByte(reply).Slice(4));
            }
        ...
        public short SpiRead16(SpiMessageType MessageType)
        {
            ...
            if (reply[3] == SpiCorrectDataReturned)
            {
                return BinaryPrimitives.ReadInt16BigEndian(new SpanByte(reply).Slice(4));
            }
        ...
        public MotorStatus GetMotorStatus(MotorPort port)
        {
            ...
            if (reply[3] == SpiCorrectDataReturned)
            {
                ...
                motorStatus.Encoder = (int)(BinaryPrimitives.ReadInt32BigEndian(new SpanByte(reply).Slice(6)) / MotorTicksPerDegree);
