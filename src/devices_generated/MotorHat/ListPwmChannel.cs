...
{
    /// <summary>
    /// List class for type PwmChannel that has been automatically generated
    /// </summary>
    public class ListPwmChannel : IEnumerable
    {
        ...
        public ListPwmChannel(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListPwmChannel(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public PwmChannel this[int index]
        {
            get
            {
        ...
        public void Add(PwmChannel item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type PwmChannel is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListPwmChannel _collection;
        ...
        public bool Contains(PwmChannel item)
        {
            foreach (var elem in _list)
            {
                if (((PwmChannel)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(PwmChannel[] array, int arrayIndex)
        {
        ...
        public void CopyTo(PwmChannel[] array)
        {
        ...
        public void CopyTo(int index, PwmChannel[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (PwmChannel)_list[i];
            }
        }
        ...
        public ListPwmChannel GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListPwmChannel();
            for (int i = index; i < count; i++)
            {
                list.Add((PwmChannel)_list[i]);
            }
        ...
        public int IndexOf(PwmChannel item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(PwmChannel item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(PwmChannel item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, PwmChannel item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type PwmChannel is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(PwmChannel item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(PwmChannel item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(PwmChannel item, int index, int count)
        {
            ...
            {
                if (((PwmChannel)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(PwmChannel item)
        {
        ...
        public PwmChannel[] ToArray()
        {
            PwmChannel[] array = new PwmChannel[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (PwmChannel)_list[i];
            }
