...
Debug.WriteLine("Hello NDEF!");
Debug.WriteLine("Which NFC reader do you want to use?");
Debug.WriteLine(" 1. PN5180");
Debug.WriteLine(" 2. PN532");
var nfc = Console.ReadKey();
Debug.WriteLine();
if (nfc is not { KeyChar: '1' or '2' })
{
    Debug.WriteLine("Please chose either PN532 or PN1850");
    return;
}

Debug.WriteLine("What do you want to do?");
Debug.WriteLine(" 1. Dump the a full Mifare card");
Debug.WriteLine(" 2. Read the NDEF records present on a Mifare card");
Debug.WriteLine(" 3. Format a Mifare card as NDEF");
Debug.WriteLine(" 4. Write a short NDEF content (a Text and a Geo record)");
Debug.WriteLine(" 5. Write a long NDEF content (a Text, a Geo record and aURL)");
Debug.WriteLine(" 6. Check if the card is NDEF formated");
Debug.WriteLine(" 7. Erase sector 1 with default key A and B");
var testToRun = Console.ReadKey();
Debug.WriteLine();

if (nfc.KeyChar == '1')
{
    Debug.WriteLine("Which type of platform do you want to use for PN5180?");
    Debug.WriteLine(" 1. Hardware SPI like Raspberry Pi");
    ...
    switch (choice.KeyChar)
    {
        ...
        case '2':
            ...
            break;
        default:
            Debug.WriteLine("Sorry, I can't understand your choice");
            return;
    }
    ...
    Debug.WriteLine("Place a type A card on reader");
...
{
    Debug.WriteLine("Which interface do you want to use for PN532?");
    ...
    {
        Debug.WriteLine($"Is it a PN532!: {version.IsPn532}, Version: {version.Version}, Version supported: {version.VersionSupported}");
    }
    else
    {
        Debug.WriteLine($"Error connecting to PN532");
        return;
    }
...
void RunTestNdef(CardTransceiver transceiver, Data106kbpsTypeA card)
{
    ...
    switch (testToRun.KeyChar)
    {
        ...
        case '7':
            ...
            Debug.WriteLine($"The sector has{isErased} been erased");
            break;
        default:
            Debug.WriteLine("Sorry, I can't understand your choice");
            return;
...
{
    Debug.WriteLine("Reading Mifare card content");
