...
{
    /// <summary>
    /// List class for type Ushort that has been automatically generated
    /// </summary>
    public class ListUshort : IEnumerable
    {
        ...
        public ListUshort(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListUshort(int capacity)
        {
            if (capacity < 0)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ushort is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListUshort _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListUshort collection)
            {
                _index = 0;
            ...
            /// </summary>
            public ushort Current => _collection[_index];
        ...
        public bool Contains(ushort item)
        {
            ...
            {
                if (((ushort)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(int index, ushort[] array, int arrayIndex, int count)
        {
            ...
            {
                array[arrayIndex + i] = (ushort)_list[i];
            }
        }
        ...
        public ListUshort GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListUshort();
            for (int i = index; i < count; i++)
            {
                list.Add((ushort)_list[i]);
            }
        ...
        public int IndexOf(ushort item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ushort item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ushort item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ushort item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ushort is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ushort item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ushort item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ushort item, int index, int count)
        {
            ...
            {
                if (((ushort)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        {
            ushort[] array = new ushort[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ushort)_list[i];
            }
