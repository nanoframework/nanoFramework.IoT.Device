...
{
    /// <summary>
    /// List class for type ApplicationDataDetail that has been automatically generated
    /// </summary>
    public class ListApplicationDataDetail : IEnumerable
    {
        ...
        /// </summary>
        public ListApplicationDataDetail()
        {
            _list = new ArrayList();
        }
        ...
        public ListApplicationDataDetail(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListApplicationDataDetail(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public ApplicationDataDetail this[int index]
        {
            get
            {
                ...
                return (ApplicationDataDetail)_list[index];
            }
        ...
        public void Add(ApplicationDataDetail item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type ApplicationDataDetail is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListApplicationDataDetail _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListApplicationDataDetail collection)
            {
                _index = 0;
            ...
            /// </summary>
            public ApplicationDataDetail Current => _collection[_index];
        ...
        public bool Contains(ApplicationDataDetail item)
        {
            foreach (var elem in _list)
            {
                if (((ApplicationDataDetail)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(ApplicationDataDetail[] array, int arrayIndex)
        {
        ...
        public void CopyTo(ApplicationDataDetail[] array)
        {
        ...
        public void CopyTo(int index, ApplicationDataDetail[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (ApplicationDataDetail)_list[i];
            }
        }
        ...
        public ListApplicationDataDetail GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListApplicationDataDetail();
            for (int i = index; i < count; i++)
            {
                list.Add((ApplicationDataDetail)_list[i]);
            }
        ...
        public int IndexOf(ApplicationDataDetail item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(ApplicationDataDetail item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(ApplicationDataDetail item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, ApplicationDataDetail item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type ApplicationDataDetail is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(ApplicationDataDetail item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(ApplicationDataDetail item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(ApplicationDataDetail item, int index, int count)
        {
            ...
            {
                if (((ApplicationDataDetail)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(ApplicationDataDetail item)
        {
        ...
        public ApplicationDataDetail[] ToArray()
        {
            ApplicationDataDetail[] array = new ApplicationDataDetail[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (ApplicationDataDetail)_list[i];
            }
