...
{
    /// <summary>
    /// List class for type TagDetails that has been automatically generated
    /// </summary>
    public class ListTagDetails : IEnumerable
    {
        ...
        public ListTagDetails(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListTagDetails(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public TagDetails this[int index]
        {
            get
            {
        ...
        public void Add(TagDetails item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type TagDetails is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListTagDetails _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListTagDetails collection)
            {
                _index = 0;
            ...
            /// </summary>
            public TagDetails Current => _collection[_index];
        ...
        public bool Contains(TagDetails item)
        {
            foreach (var elem in _list)
            {
                if (((TagDetails)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(TagDetails[] array, int arrayIndex)
        {
        ...
        public void CopyTo(TagDetails[] array)
        {
        ...
        public void CopyTo(int index, TagDetails[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (TagDetails)_list[i];
            }
        }
        ...
        public ListTagDetails GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListTagDetails();
            for (int i = index; i < count; i++)
            {
                list.Add((TagDetails)_list[i]);
            }
        ...
        public int IndexOf(TagDetails item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(TagDetails item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(TagDetails item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, TagDetails item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type TagDetails is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(TagDetails item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(TagDetails item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(TagDetails item, int index, int count)
        {
            ...
            {
                if (((TagDetails)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(TagDetails item)
        {
        ...
        public TagDetails[] ToArray()
        {
            TagDetails[] array = new TagDetails[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (TagDetails)_list[i];
            }
