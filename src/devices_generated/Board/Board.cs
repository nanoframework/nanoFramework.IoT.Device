...
namespace Iot.Device.Board
{
    ...
    public abstract class Board : MarshalByRefObject, IDisposable
    {
        ...
        private readonly Dictionary<int, ListPinReservation> _pinReservations;
        ...
        protected Board()
        {
            _pinReservations = new Dictionary<int, ListPinReservation>();
        ...
        public virtual void ReservePin(int pinNumber, PinUsage usage, object owner)
        {
            ...
            lock (_pinReservationsLock)
            {
                ...
                {
                    if (_pinReservations.TryGetValue(pinNumber, out ListPinReservation? reservations))
                    {
                    ...
                    _pinReservations.Add(pinNumber, new ListPinReservation() { rsv });
                }
                else
                {
                    if (_pinReservations.TryGetValue(pinNumber, out ListPinReservation? reservations))
                    ...
                    {
                        reservations = new ListPinReservation();
