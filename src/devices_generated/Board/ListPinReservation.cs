...
{
    /// <summary>
    /// List class for type PinReservation that has been automatically generated
    /// </summary>
    public class ListPinReservation : IEnumerable
    {
        ...
        public ListPinReservation(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListPinReservation(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public PinReservation this[int index]
        {
            get
            {
                ...
                return (PinReservation)_list[index];
            }
        ...
        public void Add(PinReservation item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type PinReservation is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListPinReservation _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListPinReservation collection)
            {
                _index = 0;
            ...
            /// </summary>
            public PinReservation Current => _collection[_index];
        ...
        public bool Contains(PinReservation item)
        {
            foreach (var elem in _list)
            {
                if (((PinReservation)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(PinReservation[] array, int arrayIndex)
        {
        ...
        public void CopyTo(PinReservation[] array)
        {
        ...
        public void CopyTo(int index, PinReservation[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (PinReservation)_list[i];
            }
        }
        ...
        public ListPinReservation GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListPinReservation();
            for (int i = index; i < count; i++)
            {
                list.Add((PinReservation)_list[i]);
            }
        ...
        public int IndexOf(PinReservation item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(PinReservation item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(PinReservation item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, PinReservation item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type PinReservation is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(PinReservation item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(PinReservation item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(PinReservation item, int index, int count)
        {
            ...
            {
                if (((PinReservation)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(PinReservation item)
        {
        ...
        public PinReservation[] ToArray()
        {
            PinReservation[] array = new PinReservation[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (PinReservation)_list[i];
            }
