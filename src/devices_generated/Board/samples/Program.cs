...
namespace BoardSample
{
    ...
    public class Program
    {
        ...
        {
            Debug.WriteLine("Board abstraction test. Press any key to start.");
        ...
        private static void WindowsDesktop()
        {
            ...
            {
                Debug.WriteLine("Blinking keyboard test. Press ESC to quit");
                ...
                Debug.WriteLine($"Input test: This polls the 'A' key, ESC to quit");
                ...
                while (key != ConsoleKey.Escape)
                {
                    ...
                    {
                        Debug.WriteLine("Key is pressed");
                    }
                    else
                    {
                        Debug.WriteLine("Key is not pressed");
                    }
                ...
                key = ConsoleKey.NoName;
                Debug.WriteLine($"Interrupt test: This listens on the 'A' key, ESC to quit");
                controller.SetPinMode(pinNumber, PinMode.Input);
        ...
        private static void PwmRaspiTest(RaspberryPiBoard raspi)
        {
            ...
            Debug.WriteLine("Blinking and dimming an LED - Press any key to quit");
            while (!Console.KeyAvailable)
            {
        ...
        {
            Debug.WriteLine("MCP3008 SPI Software CS Test");
            ...
            while (!Console.KeyAvailable)
            {
                for (int i = 0; i < 8; i++)
                {
                    ...
                    ctrl.Write(8, PinValue.High);
                    Debug.WriteLine($"Channel {i} has value {value}.");
                    Thread.Sleep(100);
                }
        ...
        {
            Debug.WriteLine("MCP3008 SPI Hardware CS Test");
