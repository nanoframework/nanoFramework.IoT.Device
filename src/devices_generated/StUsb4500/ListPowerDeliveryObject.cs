...
{
    /// <summary>
    /// List class for type PowerDeliveryObject that has been automatically generated
    /// </summary>
    public class ListPowerDeliveryObject : IEnumerable
    {
        ...
        /// </summary>
        public ListPowerDeliveryObject()
        {
            _list = new ArrayList();
        }
        ...
        public ListPowerDeliveryObject(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListPowerDeliveryObject(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public PowerDeliveryObject this[int index]
        {
            get
            {
                ...
                return (PowerDeliveryObject)_list[index];
            }
        ...
        public void Add(PowerDeliveryObject item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type PowerDeliveryObject is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListPowerDeliveryObject _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListPowerDeliveryObject collection)
            {
                _index = -1;
            ...
            /// </summary>
            public PowerDeliveryObject Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(PowerDeliveryObject item)
        {
            foreach (var elem in _list)
            {
                if (((PowerDeliveryObject)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(PowerDeliveryObject[] array, int arrayIndex)
        {
        ...
        public void CopyTo(PowerDeliveryObject[] array)
        {
        ...
        public void CopyTo(int index, PowerDeliveryObject[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (PowerDeliveryObject)_list[i];
            }
        }
        ...
        public ListPowerDeliveryObject GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListPowerDeliveryObject();
            for (int i = index; i < count; i++)
            {
                list.Add((PowerDeliveryObject)_list[i]);
            }
        ...
        public int IndexOf(PowerDeliveryObject item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(PowerDeliveryObject item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(PowerDeliveryObject item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, PowerDeliveryObject item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type PowerDeliveryObject is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(PowerDeliveryObject item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(PowerDeliveryObject item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(PowerDeliveryObject item, int index, int count)
        {
            ...
            {
                if (((PowerDeliveryObject)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(PowerDeliveryObject item)
        {
        ...
        public PowerDeliveryObject[] ToArray()
        {
            PowerDeliveryObject[] array = new PowerDeliveryObject[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (PowerDeliveryObject)_list[i];
            }
