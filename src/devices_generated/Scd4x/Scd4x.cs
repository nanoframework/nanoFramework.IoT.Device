...
namespace Iot.Device.Scd4x
{
    ...
    public sealed class Scd4x : IDisposable
    {
        ...
        {
            if (!_started || _nextReadPeriod - DateTime.UtcNow.Ticks <= 0)
            {
        ...
        public void StartPeriodicMeasurements()
        {
            ...
            _nextReadPeriod = DateTime.UtcNow.Ticks + MeasurementPeriodMs;
            _started = true;
        }
        ...
        private async ValueTask<(VolumeConcentration? CarbonDioxide, RelativeHumidity? RelativeHumidity, Temperature? Temperature)> ReadPeriodicMeasurementImpl(CancellationToken cancellationToken, bool async)
        {
            ...
            int delay = _nextReadPeriod - DateTime.UtcNow.Ticks;
            ...
            int waitStart = DateTime.UtcNow.Ticks;
            ...
            while (true)
            {
                ...
                if (DateTime.UtcNow.Ticks - waitStart > (MeasurementPeriodMs + 1000))
                {
            ...
            _nextReadPeriod = DateTime.UtcNow.Ticks + 5000;
