...
{
    /// <summary>
    /// List class for type Tag that has been automatically generated
    /// </summary>
    public class ListTag : IEnumerable
    {
        ...
        public ListTag(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Tag is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListTag _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListTag collection)
            {
                _index = 0;
            ...
            /// </summary>
            public Tag Current => _collection[_index];
        ...
        public bool Contains(Tag item)
        {
            ...
            {
                if (((Tag)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(int index, Tag[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Tag)_list[i];
            }
        }
        ...
        public ListTag GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
        ...
        public int IndexOf(Tag item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Tag item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Tag item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Tag item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Tag is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Tag item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Tag item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Tag item, int index, int count)
        {
            ...
            {
                if (((Tag)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
