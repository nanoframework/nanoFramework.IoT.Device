...
{
    /// <summary>
    /// List class for type PixelFormat that has been automatically generated
    /// </summary>
    public class ListPixelFormat : IEnumerable
    {
        ...
        public ListPixelFormat(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListPixelFormat(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public PixelFormat this[int index]
        {
            get
            {
                ...
                return (PixelFormat)_list[index];
            }
        ...
        public void Add(PixelFormat item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type PixelFormat is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListPixelFormat _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListPixelFormat collection)
            {
                _index = 0;
            ...
            /// </summary>
            public PixelFormat Current => _collection[_index];
        ...
        public bool Contains(PixelFormat item)
        {
            foreach (var elem in _list)
            {
                if (((PixelFormat)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(PixelFormat[] array, int arrayIndex)
        {
        ...
        public void CopyTo(PixelFormat[] array)
        {
        ...
        public void CopyTo(int index, PixelFormat[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (PixelFormat)_list[i];
            }
        }
        ...
        public ListPixelFormat GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListPixelFormat();
            for (int i = index; i < count; i++)
            {
                list.Add((PixelFormat)_list[i]);
            }
        ...
        public int IndexOf(PixelFormat item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(PixelFormat item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(PixelFormat item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, PixelFormat item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type PixelFormat is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(PixelFormat item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(PixelFormat item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(PixelFormat item, int index, int count)
        {
            ...
            {
                if (((PixelFormat)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(PixelFormat item)
        {
        ...
        public PixelFormat[] ToArray()
        {
            PixelFormat[] array = new PixelFormat[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (PixelFormat)_list[i];
            }
