...
{
    /// <summary>
    /// List class for type Resolution that has been automatically generated
    /// </summary>
    public class ListResolution : IEnumerable
    {
        ...
        public ListResolution(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListResolution(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public Resolution this[int index]
        {
            get
            {
        ...
        public void Add(Resolution item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Resolution is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListResolution _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListResolution collection)
            {
                _index = 0;
            ...
            /// </summary>
            public Resolution Current => _collection[_index];
        ...
        public bool Contains(Resolution item)
        {
            foreach (var elem in _list)
            {
                if (((Resolution)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(Resolution[] array, int arrayIndex)
        {
        ...
        public void CopyTo(Resolution[] array)
        {
        ...
        public void CopyTo(int index, Resolution[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Resolution)_list[i];
            }
        }
        ...
        public ListResolution GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListResolution();
            for (int i = index; i < count; i++)
            {
                list.Add((Resolution)_list[i]);
            }
        ...
        public int IndexOf(Resolution item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Resolution item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Resolution item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Resolution item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Resolution is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Resolution item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Resolution item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Resolution item, int index, int count)
        {
            ...
            {
                if (((Resolution)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(Resolution item)
        {
        ...
        public Resolution[] ToArray()
        {
            Resolution[] array = new Resolution[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (Resolution)_list[i];
            }
