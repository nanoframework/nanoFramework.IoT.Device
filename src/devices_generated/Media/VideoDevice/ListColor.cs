...
{
    /// <summary>
    /// List class for type Color that has been automatically generated
    /// </summary>
    public class ListColor : IEnumerable
    {
        ...
        public ListColor(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Color is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListColor _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListColor collection)
            {
                _index = 0;
            ...
            /// </summary>
            public Color Current => _collection[_index];
        ...
        public bool Contains(Color item)
        {
            ...
            {
                if (((Color)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(Color[] array)
        {
        ...
        public void CopyTo(int index, Color[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Color)_list[i];
            }
        }
        ...
        public ListColor GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListColor();
            for (int i = index; i < count; i++)
            {
                list.Add((Color)_list[i]);
            }
        ...
        public int IndexOf(Color item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Color item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Color item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Color item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Color is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Color item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Color item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Color item, int index, int count)
        {
            ...
            {
                if (((Color)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        {
            Color[] array = new Color[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (Color)_list[i];
            }
