namespace System
{
    ...
    public readonly ref struct SpanFont
    {
        private readonly Font[] _array;  // internal array
        ...
        /// </exception>
        public SpanFont(Font[] array, int start, int length)
        {
            if (array != null)
            {
                if (start < 0 ||
        ...
        // public ref Font this[int index] => ref _array[_start + index]; // <= this is not working and raises exception after few access
        ...
        /// </summary>
        public static SpanFont Empty => new SpanFont();
        ...
        /// </exception>
        public void CopyTo(SpanFont destination)
        {
        ...
        public SpanFont Slice(int start)
        {
        ...
        public SpanFont Slice(int start, int length)
        {
            ...
            return new SpanFont(_array, _start + start, length);
        }
        ...
        public static implicit operator SpanFont(Font[] array)
        {
            return new(array);
        }
    }
