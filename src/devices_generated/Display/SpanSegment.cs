namespace System
{
    ...
    public readonly ref struct SpanSegment
    {
        private readonly Segment[] _array;  // internal array
        ...
        public SpanSegment(Segment[] array)
        {
            _array = array;
        ...
        /// </exception>
        public SpanSegment(Segment[] array, int start, int length)
        {
            if (array != null)
            {
                if (start < 0 ||
        ...
        // public ref Segment this[int index] => ref _array[_start + index]; // <= this is not working and raises exception after few access
        ...
        /// </summary>
        public static SpanSegment Empty => new SpanSegment();
        ...
        /// </exception>
        public void CopyTo(SpanSegment destination)
        {
        ...
        public SpanSegment Slice(int start)
        {
        ...
        public SpanSegment Slice(int start, int length)
        {
            ...
            return new SpanSegment(_array, _start + start, length);
        }
        ...
        public static implicit operator SpanSegment(Segment[] array)
        {
            return new(array);
        }
    }
