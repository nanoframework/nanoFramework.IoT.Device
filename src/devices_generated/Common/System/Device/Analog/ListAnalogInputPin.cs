...
{
    /// <summary>
    /// List class for type AnalogInputPin that has been automatically generated
    /// </summary>
    public class ListAnalogInputPin : IEnumerable
    {
        ...
        public ListAnalogInputPin(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListAnalogInputPin(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public AnalogInputPin this[int index]
        {
            get
            {
                ...
                return (AnalogInputPin)_list[index];
            }
        ...
        public void Add(AnalogInputPin item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type AnalogInputPin is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListAnalogInputPin _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListAnalogInputPin collection)
            {
                _index = -1;
            ...
            /// </summary>
            public AnalogInputPin Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(AnalogInputPin item)
        {
            foreach (var elem in _list)
            {
                if (((AnalogInputPin)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(AnalogInputPin[] array, int arrayIndex)
        {
        ...
        public void CopyTo(AnalogInputPin[] array)
        {
        ...
        public void CopyTo(int index, AnalogInputPin[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (AnalogInputPin)_list[i];
            }
        }
        ...
        public ListAnalogInputPin GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListAnalogInputPin();
            for (int i = index; i < count; i++)
            {
                list.Add((AnalogInputPin)_list[i]);
            }
        ...
        public int IndexOf(AnalogInputPin item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(AnalogInputPin item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(AnalogInputPin item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, AnalogInputPin item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type AnalogInputPin is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(AnalogInputPin item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(AnalogInputPin item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(AnalogInputPin item, int index, int count)
        {
            ...
            {
                if (((AnalogInputPin)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(AnalogInputPin item)
        {
        ...
        public AnalogInputPin[] ToArray()
        {
            AnalogInputPin[] array = new AnalogInputPin[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (AnalogInputPin)_list[i];
            }
