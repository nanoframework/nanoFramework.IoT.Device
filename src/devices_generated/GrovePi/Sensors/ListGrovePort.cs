...
{
    /// <summary>
    /// List class for type GrovePort that has been automatically generated
    /// </summary>
    public class ListGrovePort : IEnumerable
    {
        ...
        public ListGrovePort(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListGrovePort(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public GrovePort this[int index]
        {
            get
            {
        ...
        public void Add(GrovePort item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type GrovePort is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListGrovePort _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListGrovePort collection)
            {
                _index = -1;
            ...
            /// </summary>
            public GrovePort Current => _collection[_index == -1 ? 0 : _index];
        ...
        public bool Contains(GrovePort item)
        {
            foreach (var elem in _list)
            {
                if (((GrovePort)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(GrovePort[] array, int arrayIndex)
        {
        ...
        public void CopyTo(GrovePort[] array)
        {
        ...
        public void CopyTo(int index, GrovePort[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (GrovePort)_list[i];
            }
        }
        ...
        public ListGrovePort GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListGrovePort();
            for (int i = index; i < count; i++)
            {
                list.Add((GrovePort)_list[i]);
            }
        ...
        public int IndexOf(GrovePort item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(GrovePort item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(GrovePort item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, GrovePort item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type GrovePort is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(GrovePort item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(GrovePort item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(GrovePort item, int index, int count)
        {
            ...
            {
                if (((GrovePort)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(GrovePort item)
        {
        ...
        public GrovePort[] ToArray()
        {
            GrovePort[] array = new GrovePort[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (GrovePort)_list[i];
            }
