...
{
    /// <summary>
    /// List class for type MonitoringJob that has been automatically generated
    /// </summary>
    public class ListMonitoringJob : IEnumerable
    {
        ...
        public ListMonitoringJob(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListMonitoringJob(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public MonitoringJob this[int index]
        {
            get
            {
                ...
                return (MonitoringJob)_list[index];
            }
        ...
        public void Add(MonitoringJob item)
        {
            _list.Add(item);
        }
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type MonitoringJob is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListMonitoringJob _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListMonitoringJob collection)
            {
                _index = 0;
            ...
            /// </summary>
            public MonitoringJob Current => _collection[_index];
        ...
        public bool Contains(MonitoringJob item)
        {
            foreach (var elem in _list)
            {
                if (((MonitoringJob)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(MonitoringJob[] array, int arrayIndex)
        {
        ...
        public void CopyTo(MonitoringJob[] array)
        {
        ...
        public void CopyTo(int index, MonitoringJob[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (MonitoringJob)_list[i];
            }
        }
        ...
        public ListMonitoringJob GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListMonitoringJob();
            for (int i = index; i < count; i++)
            {
                list.Add((MonitoringJob)_list[i]);
            }
        ...
        public int IndexOf(MonitoringJob item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(MonitoringJob item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(MonitoringJob item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, MonitoringJob item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type MonitoringJob is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(MonitoringJob item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(MonitoringJob item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(MonitoringJob item, int index, int count)
        {
            ...
            {
                if (((MonitoringJob)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(MonitoringJob item)
        {
        ...
        public MonitoringJob[] ToArray()
        {
            MonitoringJob[] array = new MonitoringJob[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (MonitoringJob)_list[i];
            }
