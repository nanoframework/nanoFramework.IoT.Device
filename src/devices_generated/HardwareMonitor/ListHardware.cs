...
{
    /// <summary>
    /// List class for type Hardware that has been automatically generated
    /// </summary>
    public class ListHardware : IEnumerable
    {
        ...
        public ListHardware(IEnumerable collection)
        {
            if (collection == null)
            {
        ...
        public ListHardware(int capacity)
        {
            if (capacity < 0)
            {
        ...
        public Hardware this[int index]
        {
            get
            {
        ...
        /// The collection itself cannot be null, but it can contain elements that are null, if type Hardware is a reference type.
        /// </param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        ...
        {
            private int _index;
            private ListHardware _collection;

            /// <summary>
            /// Create an enumerator of the collection
            /// </summary>
            /// <param name="collection"></param>
            public Enumerator(ListHardware collection)
            {
                _index = 0;
            ...
            /// </summary>
            public Hardware Current => _collection[_index];
        ...
        public bool Contains(Hardware item)
        {
            foreach (var elem in _list)
            {
                if (((Hardware)elem).GetHashCode() == item.GetHashCode())
                {
                    return true;
                }
            }
        ...
        public void CopyTo(Hardware[] array, int arrayIndex)
        {
        ...
        public void CopyTo(Hardware[] array)
        {
        ...
        public void CopyTo(int index, Hardware[] array, int arrayIndex, int count)
        {
            if (array == null)
            {
                throw new ArgumentNullException();
            ...
            {
                array[arrayIndex + i] = (Hardware)_list[i];
            }
        }
        ...
        public ListHardware GetRange(int index, int count)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException();
            ...
            var list = new ListHardware();
            for (int i = index; i < count; i++)
            {
                list.Add((Hardware)_list[i]);
            }
        ...
        public int IndexOf(Hardware item, int index, int count) => _list.IndexOf(item, index, count);
        ...
        public int IndexOf(Hardware item, int index) => IndexOf(item, index, _list.Count - index);
        ...
        public int IndexOf(Hardware item) => IndexOf(item, 0, _list.Count);
        ...
        public void Insert(int index, Hardware item) => _list.Insert(index, item);

        /// <summary>
        /// Inserts the elements of a collection into the System.Collections.Generic.List at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the new elements should be inserted.</param>
        /// <param name="collection">The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be null, but it can contain elements that are null, if type Hardware is a reference type.</param>
        /// <exception cref="System.ArgumentNullException">collection is null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">index is less than 0. -or- index is greater than System.Collections.Generic.List.Count.</exception>
        ...
        public int LastIndexOf(Hardware item) => LastIndexOf(item, _list.Count - 1, _list.Count);
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">index is outside the range of valid indexes for the System.Collections.Generic.List.</exception>
        public int LastIndexOf(Hardware item, int index) => LastIndexOf(item, index, _list.Count - index);
        ...
        public int LastIndexOf(Hardware item, int index, int count)
        {
            ...
            {
                if (((Hardware)_list[i]).GetHashCode() == item.GetHashCode())
                {
                    return i;
                }
            }
        ...
        public bool Remove(Hardware item)
        {
        ...
        public Hardware[] ToArray()
        {
            Hardware[] array = new Hardware[_list.Count];
            for (int i = 0; i < array.Length; i++)
            {
                array[i] = (Hardware)_list[i];
            }
